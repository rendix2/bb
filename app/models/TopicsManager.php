...
class TopicsManager extends Crud\CrudManager {
     ...
     */
    public function __construct(\Dibi\Connection $dibi, \App\Models\PostsManager $postManager, \App\Models\UsersManager $userManager, \App\Models\ThanksManager $thanksManager) {
