...
class PostPresenter extends Base\ForumPresenter {
    ...
    public function actionDeleteTopic($forum_id, $topic_id) {
    ...
    public function editTopicFormSuccess(\Nette\Application\UI\Form $form, \Nette\Utils\ArrayHash $values) {
        ...
        $this->forumManager->update($forum_id, \Nette\Utils\ArrayHash::from(['forum_last_post_id' => $post_id, 'forum_last_post_user_id' => $user_id, 'forum_last_topic_id' => $post_topic_id]));
    ...
    public function editPostFormSuccess(\Nette\Application\UI\Form $form, \Nette\Utils\ArrayHash $values) {
        ...
        if ($post_id) {
            ...
            $this->forumManager->update($forum_id, \Nette\Utils\ArrayHash::from(['forum_last_post_id' => $post_id, 'forum_last_post_user_id' => $user_id]));
        }
