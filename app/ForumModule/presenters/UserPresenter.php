...
class UserPresenter extends Base\ForumPresenter {
    ...
    public function editUserFormSuccess(\Nette\Application\UI\Form $form, \Nette\Utils\ArrayHash $values) {
        ...
        $values->user_avatar = $this->getManager()->movieAvatar($values->user_avatar, $this->getContext()->getParameters()['wwwDir']);
    ...
    protected function createComponentChangePasswordControl() {
        return new \App\Controls\ChangePasswordControl($this->getManager(), $this->getForumTranslator(), $this->getUser());
    }
