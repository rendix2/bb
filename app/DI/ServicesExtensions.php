...
use App\Core\UserLoginAttemptCheckService;
...
class ServicesExtension extends CompilerExtension
{
    ...
    private function registerServices() : void
    {
        ...
        $builder->addDefinition($this->prefix('UserLoginAttemptCheckService'), (new ServiceDefinition())->setType(UserLoginAttemptCheckService::class));
    }
